...
function LoginContent() {
  ...
  const callbackUrl = params.get('callbackUrl') || '/mi-cuenta'
  ...
  return (
    <div className="min-h-screen bg-[#f5f9fd] flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-lg p-8 max-w-sm w-full text-center">
        ...
        <p className="text-gray-400 text-sm mb-8">Para ver tus reservas y datos guardados</p>
        ...
        <p className="text-xs text-gray-400 mt-6">
          Al ingresar aceptás que guardemos tus datos para gestionar tus reservas.
        </p>
      </div>
    </div>
  )
